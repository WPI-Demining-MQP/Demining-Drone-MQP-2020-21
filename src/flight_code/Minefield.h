...
#define MAX_NUM_MINES 15000   // Maximum number of mines that can be stored at once. This can theoretically be as high as 2^16-1 , though we only have memory for ~15k
